...
<html lang="en-es">
    ...
    <body class="theme-blush">
        ...
        <section class="content">
            <form method="post" action="ControladorFuncionario.php">
                                ...
                                <div class="body">
                                    <div class="row clearfix">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input name="documento_funcionario" type="number" class="form-control" placeholder="Documento">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input name="correo" type="email" class="form-control" placeholder="Correo" required="required" />
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group drop-custum">
                                                <select name="rol_fk" class="form-control show-tick">
                                                    <option value="">Seleccione el rol</option>
                                                    <?php
                                                    foreach ($arreglorol as $rol):
                                                        ?>
